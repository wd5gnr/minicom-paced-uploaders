...
// You can use this for any situation where you need to upload from minicom to
// something that can't handle data full speed ahead

// 17 Sept 2010 -- Public Domain
// 22 Sept 2010 -- Added forced return at end of file
// 14 July 2022 -- Minor clean up
 #include <stdio.h>
 #include <stdlib.h>
 #include <unistd.h>
 #include <ctype.h>
